...
out_dir = './data/phonemes/out/' # ignored if init_from is not 'resume'
...
if load_meta:
    ...
    print("No meta.pkl found, using custom-trained phoneme tokenizer...")
    tokenizer_path = './data/phonemes/tok2048.model'
    tokenizer_instance = Tokenizer(tokenizer_path)
    #enc = tiktoken.get_encoding("gpt2")
    encode = lambda s: tokenizer_instance.encode(s, bos=True, eos=False)
    decode = lambda l: tokenizer_instance.decode(l)
